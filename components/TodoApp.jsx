...
export default function TodoApp() {
  const { logEvent, setFocusTaskId } = useContext(ExplanationContext);
  ...
  useEffect(() => {
    ...
    if (enabled !== emptyEnabledRef.current) {
      logEvent(enabled ? "Enabled Empty archive" : "Disabled Empty archive", "TodoApp", { archivedCount }, "auto", "syntactic");
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (enabled !== addEnabledRef.current) {
              logEvent(enabled ? "Enabled Add button" : "Disabled Add button", "TodoApp", { length: v.trim().length }, "auto", "syntactic");
